...
.controller('ImagesEditCtrl', ['$scope', '$www', 'Modal', 'Fabric', 'FabricConstants', 'ImagesConstants', 'Keypress', '$localStorage', function($scope, $www, Modal, Fabric, FabricConstants, ImagesConstants, Keypress, $localStorage) {
